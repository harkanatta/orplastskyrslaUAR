...
\caption{Helstu uppsprettur örplasts á Íslandi og skipting þess eftir farleiðum í haf eða í jarðveg. Byggt á lægra mati.}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Helstu uppsprettur örplasts á Íslandi og skipting þess eftir farleiðum í haf eða í jarðveg. Byggt á lægra mati.}\label{fig:unnamed-chunk-6}
\end{figure}
