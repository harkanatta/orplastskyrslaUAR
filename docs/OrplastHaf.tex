...
\newtcbox{grattbox}[1][]{enhanced jigsaw,
  sharp corners,
  colback=gray!6,
  center,
  varwidth upper=0.85\linewidth,
  frame hidden,
  width=\linewidth-7cm,
  #1}
...
\HRule \\[0.4cm]
{ \huge \bfseries Örplast í hafinu við Ísland}\\[0.4cm] % Title of your document
...
Valtýr Sigurðsson\\[.2cm] % Your name
...
\includegraphics{myndir/biopollogo.png}\\ % Include a department/university logo - this will require the graphicx package
\includegraphics{myndir/nnvlogo.png}\\ % Include a department/university logo - this will require the graphicx package
 \end{minipage}\\
...
\midrule
& \rowcolor{gray!6} Plastagnir & Frumplast, snyrtivörur, málningarflyksur, pakningar, borðbúnaður\\
& Plastþræðir & Fiskinet, textílþræðir, sígarettufilterar\\
\multirow{-5}{*}{\centering\arraybackslash {\shortstack{Hitadeigt (pólýetýlen,\\ pólýprópýlen, pólýstýren,\\ vínyl)}}} & \rowcolor{gray!6} Plastfrauð & Baujur og flotholt úr pólýstýreni, vörupakningar úr ólefínum\\
\addlinespace
\hline
\addlinespace
& Samsett plast & Bátaplast, epoxýmálning\\
& \rowcolor{gray!6} Plastfilmur & Filmur og lakk\\
& Plastfrauð & Plötur, blöð, filmur o.þ.h. með holrúmi, úr pólýúretönum\\
\multirow{-6}{*}{\centering\arraybackslash {\shortstack{Hitafast (pólýúretön,\\ stýrenbútadíen, epoxíð,\\ alkýð)}}} & \rowcolor{gray!6} Gúmmí & Blöðrur og hjólbarðar\\
\bottomrule
\end{tabular}
\end{table}
...
\toprule
\rowcolor{gray!6} Gerð farvegs & Farvegur & Uppsprettur í farvegi\\
\midrule  \hline
 &  & Fatnaður\\
\cmidrule{3-3}
 &  & Snyrtivörur\\
...
\cmidrule{3-3}
 &  & Vegryk*\\
\cmidrule{3-3}
 & \multirow{-8}{*}{\centering\arraybackslash {\shortstack{Fráveita:\\ skólp og ofanvatn}}} & Málning\\
\cmidrule{2-3}
 &  & Heyrúlluplast\\
\cmidrule{3-3}
 &  & Haglaskot\\
\cmidrule{3-3}
\multirow{-11}{*}{\centering\arraybackslash {\shortstack{Rennandi\\ vatn}}} & \multirow{-3}{*}{\centering\arraybackslash  {\shortstack{Ár, lækir\\ og skurðir}}} & Plastrusl\\
\cmidrule{1-3}
\rowcolor{gray!6} &  & Vegryk*\\
\rowcolor{gray!6} \multirow{-2}{*}{\centering\arraybackslash Andrúmsloft} & \multirow{-2}{*}{\centering\arraybackslash Vindur} & Áburður\\
\cmidrule{1-3}
 &  & Veiðarfæri\\
\cmidrule{3-3}
 &  & Búnaður í sjókvíaeldi\\
\cmidrule{3-3}
\multirow{-3}{*}{\centering\arraybackslash Hafið} & \multirow{-3}{*}{\centering\arraybackslash {\shortstack{Hafstraumar\\ og sjávarföll}}} & Plastrusl í hafinu\\
\cmidrule{1-3}
\rowcolor{gray!6} & Sigvatn & Örplast frá urðunarstöðum\\
\cmidrule{2-3}
\rowcolor{gray!6} \multirow{-2}{*}{\centering\arraybackslash Annað} & Snjómokstur & Vegryk*\\
\bottomrule
\multicolumn{3}{l}{\textsuperscript{*} Slit frá hjólbörðum og vegmerkingum}\\
\end{tabular}
\end{table}
...
\grattbox{Áætluð heildarlosun örplasts í hafið frá sliti bifreiðahjólbarða á Íslandi er \textbf{164-255 tonn}.}
...
\grattbox{Áætluð heildarlosun örplasts í hafið vegna vegmerkinga er \textbf{5,7 - 42,6 tonn}}
...
\grattbox{Áætluð losun örplasts í hafið frá útimálningu er \textbf{12-29 tonn}.}
...
\grattbox{Áætluð heildarlosun örplasts frá innimálningu á ári er \textbf{3,2 - 7,1 tonn}.}
...
{\centering \includegraphics{_bookdown_files/OrplastHaf_files/figure-latex/sank0-1} 
...
\grattbox{Losun örplasts í hafið vegna skipamálningar er áætluð vera á bilinu \textbf{3,2 - 10 tonn} á ári.}
...
\grattbox{Losun örplasts í hafið vegna frumplasts í plastframleiðslu er áætluð vera á bilinu \textbf{0,06 - 1,3 tonn} á ári.}
...
\grattbox{Losun örplasts í hafið vegna gervigrasvalla er áætluð vera á bilinu \textbf{0,3 - 1,1 tonn} á ári.}
...
\addcontentsline{toc}{section}{Neysluvörur}
...
\grattbox{Losun örplasts í hafið frá þvotti er áætluð vera á bilinu \textbf{8,2 - 32 tonn} á ári.}
...
\grattbox{Áætluð losun örplasts í hafið frá snyrtivörum á Íslandi er því \textbf{0,34 - 3,4 tonn} árlega.}
...
\grattbox{Losun örplasts í hafið með sigvatni er áætluð vera á bilinu \textbf{0,002 - 177 kíló} á ári.}
