...
```{r echo=FALSE, message=TRUE, warning=TRUE, cache=TRUE, fig.cap='Helstu uppsprettur örplasts á Íslandi og skipting eftir farleiðum í haf eða í jarðveg. Byggt á lægra mati.', fig.align='center'}
...
htmlwidgets::saveWidget(sn,"vegm.html")

#library(widgetframe)
#rammi <- frameWidget(sn)
#saveNetwork(sn,"vegm.html")
sn <- htmltools::includeHTML("vegm.html")
sn
# if (knitr::is_html_output()) {
